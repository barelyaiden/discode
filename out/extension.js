    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let set = vscode.commands.registerCommand('discode.set', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (firstInput) {
                ...
                yield vscode.window.showInformationMessage('Discode: Successfully set a webhook!');
            }
        }));
        // The share command.
        let share = vscode.commands.registerCommand('discode.share', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!configuration.get('webhook') || !configuration.get('name')) {
                ...
                yield vscode.window.showErrorMessage('Discode has not been set up! Please use the "set" command through the command palette or configure it in settings.');
            }
            else {
                ...
                if (editor) {
                    ...
                    if (`${text}`.length > 1024) {
                        ...
                        yield vscode.window.showErrorMessage('Discode: That code is longer than 1024 characters and as such, too long to send!');
                    }
                    else {
                        ...
                        try {
                            ...
                            yield vscode.window.showInformationMessage('Discode: Successfully shared code to Discord!');
                        }
                        catch (error) {
                            // Alerts the user that the webhook link is not a valid Discord webhook link.
                            yield vscode.window.showErrorMessage('Discode: The webhook configuration is invalid! Please check if everything is correct in the settings or use the "set" command through the command palette.');
                        }
                    }
                }
            }
